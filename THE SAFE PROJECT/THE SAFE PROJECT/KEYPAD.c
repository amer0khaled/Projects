...
void KEYPAD_INIT(void)
{
	...
	DIO_SET_PIN_DIR(KEYPAD_PORT,0,1);
	DIO_SET_PIN_DIR(KEYPAD_PORT,1,1);
	DIO_SET_PIN_DIR(KEYPAD_PORT,2,1);
	DIO_SET_PIN_DIR(KEYPAD_PORT,3,1);
	
	DIO_SET_PIN_DIR(KEYPAD_PORT,4,0);
	DIO_SET_PIN_DIR(KEYPAD_PORT,5,0);
	DIO_SET_PIN_DIR(KEYPAD_PORT,6,0);
	DIO_SET_PIN_DIR(KEYPAD_PORT,7,0);
	
	DIO_CONNECT_PULL_UP(KEYPAD_PORT,4,1);
	DIO_CONNECT_PULL_UP(KEYPAD_PORT,5,1);
	DIO_CONNECT_PULL_UP(KEYPAD_PORT,6,1);
	DIO_CONNECT_PULL_UP(KEYPAD_PORT,7,1);
